...
- **BERT_sentiment_analysis_kor.ipynb**  
 ...
 - **KR-FinBERT**  
 : 한국어 KR-FinBERT로 한국어 테스트 데이터에서 정확도 86.32%
...
To-do List
---
 - 금융 뉴스 21GB를 활용하여 pretraining 금융 BERT 학습 후 평가  
 - 기존에 공개된 Klue-BERT에 대해서 금융 데이터를 추가 학습(Masked Language Modeling) 후 성능 평가  
 - 추가 금융 테스트 데이터 
